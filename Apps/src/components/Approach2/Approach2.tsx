...
import { IApproach2Props } from "./IApproach2Props"
import { IApproach2State } from "./IApproach2State"

export default class Approach2 extends React.Component<IApproach2Props, IApproach2State> {

    public constructor(props: IApproach2Props) {
        super();
